...
class Merger
{
   ...
   * @param string $fpdfDest First parameter of Output method in FPDF (I=Send to standard output  D= Download file F=Save to local file  S=Return as a string)
   * @param string $fpdfName Second parameter of Output method in FPDF
   * @param boolean $fpdfIsUTF8 Third parameter of Output method in FPDF
   * @return string
   * @throws Exception On failure
   */
  public function merge($resetAfterMerge = true, $fpdfDest = '', $fpdfName = '', $fpdfIsUTF8 = false)
  {
    ...
    try {
      ...
      return $fpdi->Output($fpdfDest, $fpdfName, $fpdfIsUTF8);
